    ...
    if(isset($_REQUEST['requpdate'])){
        ...
        == "") || ($_REQUEST['course_original_price']=="")){
            ...
            if($conn->query($sql)== TRUE){
                //below msg display on form sumbit success
                $msg = '<div class="alert alert-success col-sm-6 ml-5 mt-2"
                role="alert"> Updates Successfully </div>';
            }else {
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea type="text" class="form-control" id="course_desc"
        ...
        <div class="form-group">
            <label for="course_duration">Course Duratione</label>
...
<!--div container-fluid close fromm header->
